...
public class MimeTypes {
    ...
    public static boolean isPlainText(String fileName) {
        ...
        if (mimeType.contains("text") || mimeType.contains("xml") || mimeType.contains("json") || mimeType.contains("js")) {
            return true;
        }
        return false;
    }
